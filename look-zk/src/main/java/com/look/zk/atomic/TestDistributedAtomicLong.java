...
public class TestDistributedAtomicLong extends BaseClassForTests {
    ...
    public void testCompareAndSet() throws Exception {
        final CuratorFramework client = CuratorFrameworkFactory.newClient("192.168.137.4:2181,192.168.137.5:2181", new RetryOneTime(1));
        client.start();
        try {
            ...
            DistributedAtomicLong dal = new DistributedAtomicLong(client, "/counter", new RetryOneTime(1)) {
                ...
                public byte[] valueToBytes(Long newValue) {
                    ...
                    wrapper.putLong(newValue.longValue());
                    return newData;
                }
            };
            dal.forceSet(1L);
